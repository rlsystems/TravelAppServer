...
using ServerApp.Infrastructure.Common.Extensions;
using ServerApp.Infrastructure.Common.Services;
using ServerApp.Infrastructure.HangFire;
using ServerApp.Infrastructure.Identity.Extensions;
using ServerApp.Infrastructure.Identity.Permissions;
using ServerApp.Infrastructure.Localizer;
using ServerApp.Infrastructure.Mappings;
using ServerApp.Infrastructure.Multitenancy;
using ServerApp.Infrastructure.Persistence.Contexts;
using ServerApp.Infrastructure.Seeders;
using ServerApp.Infrastructure.Swagger;
using Hangfire;
...
namespace ServerApp.Infrastructure.DependencyInjection;
