...
using ServerApp.Infrastructure.Persistence.Converters;
using ServerApp.Infrastructure.Persistence.Repositories;
...
namespace ServerApp.Infrastructure.Identity.Services;
...
public class UserService : IUserService
{
    ...
    {
        var users = await _userManager.Users.AsNoTracking().ToListAsync(); //asnotracking is a performance benefit
